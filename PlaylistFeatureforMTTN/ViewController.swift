...
//
//        let item = BLTNPageItem(title: "Choose Platform")
//        item.actionButtonTitle = "Spotify"
//        item.alternativeButtonTitle = "Next"
//        item.image = UIImage(named: "musicCode")
//        item.appearance.imageViewTintColor = .blue
//        item.appearance.actionButtonColor = .systemGreen
//        item.appearance.alternativeButtonBorderColor = .red
//        item.descriptionText = "Choose the platform to play our playlist"
//
//        item.manager?.backgroundViewStyle = .blurredDark
...
//        collectionView.refreshControl = refreshControl
    ...
    func tabMe(){
        ...
        let playlistVC = playlistLinkViewController()
        let sheetController = SheetViewController(controller: playlistVC,  sizes: [.intrinsic , .fixed(500)])
